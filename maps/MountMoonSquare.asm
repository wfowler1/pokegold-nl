...
DontLitterSignText:
	text "PLEIN VAN MT.MOON" ; "MT.MOON SQUARE"
	line "Ruim je rommel op" ; "Don't Litter"
	done
...
MountMoonSquare_MapEvents:
	...
	def_object_events
	object_event  6,  6, SPRITE_CLEFAIRY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MT_MOON_SQUARE_CLEFAIRY
	object_event  7,  6, SPRITE_CLEFAIRY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MT_MOON_SQUARE_CLEFAIRY
