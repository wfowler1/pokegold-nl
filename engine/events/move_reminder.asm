MoveReminder:
	...
	; check if we own a heart scale
    ld a, HEART_SCALE
    ld [wCurItem], a
    ld hl, wNumItems
    call CheckItem
    jr nc, .no_heart_scale
...
.move_learned
	...
	; Take a heart scale from the player
	ld a, HEART_SCALE
	ld [wCurItem], a
	ld a, 1
...
GetRemindableMoves:
	...
	; The "wBuffer2" wram label is being used to store
	...
	; moves in the move list and "wBuffer2 + 1"
...
; selected Pokémon can learn into "wBuffer2".
...
; The number of items is stored in "wBuffer2"
; The list of items is stored in "wBuffer2 + 1"
ChooseMoveToLearn:
